//=========================================================================
//
//  This file was generated by Mouse 1.6 at 2013-07-23 23:45:29 GMT
//  from grammar
//    'C:\Users\Calum\Documents\GitHub\graphclasses\K\p\src\teo\isgci\iq\iq
//    .peg'.
//
//=========================================================================
...
public class IQParser extends mouse.runtime.ParserTest
{
  ...
  private boolean top_1()
    {
      ...
      do if (!next($Term15)) return rejectInner(top_1);
        while (!EOF());
  ...
  private boolean name()
    {
      ...
      if (!ahead('"',$Term10)) return reject(name);
  ...
  private boolean idstart()
    {
      ...
      if (nextIn('a','z',$Term7)) return accept(idstart);
      if (nextIn('A','Z',$Term16)) return accept(idstart);
  ...
  private boolean idchar()
    {
      ...
      if (next('_',$Term11)) return accept(idchar);
  ...
  private boolean or()
    {
      ...
      if (!next("or",$Term12)) return reject(or);
  ...
  private boolean and()
    {
      ...
      if (!next("and",$Term6)) return reject(and);
  ...
  private boolean EOF()
    {
      ...
      if (!aheadNot($Term15)) return reject(EOF);
      return accept(EOF);
    }
  ...
  final Cache $Term6 = new Cache("\"and\"");
  ...
  final Cache $Term12 = new Cache("\"or\"");
  final Cache $Term13 = new Cache("\"<=\"");
  final Cache $Term14 = new Cache("\"not\"");
  final Cache $Term15 = new Cache("_");
  final Cache $Term16 = new Cache("[A-Z]");
