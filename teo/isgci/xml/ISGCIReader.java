...
public class ISGCIReader extends DefaultHandler{
    ...
    private HashMap<String, GraphParameter> parameterIDs;
    ...
    public ISGCIReader(DirectedGraph<GraphClass,Inclusion> g,
        ...
        parameterIDs = new HashMap<String, GraphParameter>();
    ...
    public void startElement(String uri, String locName, String qName, 
        ...
        if (Tags.PARAM_RELATION.equals(qName)) {
            ...
            rel = atts.getValue(Tags.PAR_ATT_REL);
                ...
                pgc1 = parameterIDs.get(atts.getValue(Tags.PARAM1))
                        .getPseudoClass();
                pgc2 = parameterIDs.get(atts.getValue(Tags.PARAM2))
                        .getPseudoClass();
            if (pgc1 == pgc2)
            ...
            if (rel.equals(Tags.PAR_NOT_BOUNDS)|| rel.equals(Tags.OPEN)) {
                ...
                if (rel.equals(Tags.PAR_NOT_BOUNDS))
                    curRel = new NotInclusion(pgc1, pgc2);
                else
                ...
                if (graph.containsEdge(pgc2, pgc1)
                        && curRel instanceof NotInclusion)
        ...
        if (Tags.PARAM_RELATION.equals(qName)) {
           if (rel.equals(Tags.PAR_BOUNDS) || rel.equals(Tags.PAR_EQU)
                ...
                if (rel.equals(Tags.PAR_EQU)) {
                    ...
                    NotInclusion revRel = new NotInclusion(
    ...
    private class GraphParameterWrapper {
         ...
         */
        public GraphParameterWrapper(String id, String name, String dirtype,
        ...
        public boolean generate() throws SAXException {
            ...
            Problem decomposition = (Problem) problemNames.get(
                    par.getName() + " decomposition");
            if (decomposition == null  &&  !par.isLinDecomp())
    ...
    private class ParamAlgoWrapper {
         ...
         */
        public ParamAlgoWrapper(String id, String probname,
    ...
    private class BoundednessProofWrapper {
         ...
         *            {@link Boundedness})
         */
        public BoundednessProofWrapper(String id2, String name,
    ...
    // -------------------- ParamProblemWrapper -------------
    /**
     * Serves as all-in-one help for creating/setting parameterized complexity
     * values on pseudoclasses with associated problems.
     *
     * More info can be found in the constructor.
     * @author vector
     */
